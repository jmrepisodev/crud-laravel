                            ...
                            <div class="row">
                                <form action="{{ route('cart.update') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-sm mw-25 mb-3" value="{{ $item->quantity }}"
                                               id="quantity" name="quantity" >
                                        <button class="btn btn-primary btn-sm me-3"><i class="fa fa-edit"></i></button>
                                    </div>
                                </form>
                                ...
                                <form action="{{ route('cart.remove') }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" value="{{ $item->id }}" id="id" name="id">
                                    <button class="btn btn-danger btn-sm me-3"><i class="fa fa-trash"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
